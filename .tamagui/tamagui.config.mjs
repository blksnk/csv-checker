...
var getComponentThemes = /* @__PURE__ */ __name((components) => {
...
// node_modules/@tamagui/themes/dist/esm/v5-templates.mjs
var objectFromEntries3 = /* @__PURE__ */ __name((entries) => {
  return Object.fromEntries(entries);
}, "objectFromEntries");
var objectKeys2 = /* @__PURE__ */ __name((obj) => {
  return Object.keys(obj);
}, "objectKeys");
var getTemplates2 = /* @__PURE__ */ __name(() => {
  const lightTemplates = getBaseTemplates2("light");
  const darkTemplates = getBaseTemplates2("dark");
  const templates = {
...
var getBaseTemplates2 = /* @__PURE__ */ __name((scheme) => {
  ...
  const makeSurface = /* @__PURE__ */ __name((offset, colorOffset = 0) => {
  ...
  const accent = Object.fromEntries(Object.entries(base).map(([key, index]) => {
    return [key, -index];
  }));
  return {
    base,
...
// node_modules/@tamagui/themes/dist/esm/opacify.mjs
...
// node_modules/@tamagui/themes/dist/esm/v5-themes.mjs
...
var lightPalette = ["#fff", "#f8f8f8", "hsl(0, 0%, 93%)", "hsl(0, 0%, 85%)", "hsl(0, 0%, 80%)", "hsl(0, 0%, 70%)", "hsl(0, 0%, 59%)", "hsl(0, 0%, 45%)", "hsl(0, 0%, 30%)", "hsl(0, 0%, 20%)", "hsl(0, 0%, 14%)", "hsl(0, 0%, 2%)"];
...
__name(getDefaultV5ThemeValues, "getDefaultV5ThemeValues");
function createV5Theme(options = {}) {
  ...
  return createThemes({
    ...
    grandChildrenThemes,
    getTheme: /* @__PURE__ */ __name((props) => {
...
// node_modules/@tamagui/animations-motion/dist/esm/createAnimations.mjs
...
import React3, { forwardRef, useEffect as useEffect2, useLayoutEffect, useMemo, useRef, useState } from "react";
...
var themes3 = process.env.TAMAGUI_ENVIRONMENT === "client" && process.env.NODE_ENV === "production" ? (
